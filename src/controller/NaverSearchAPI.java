...
public class NaverSearchAPI extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String clientId = "njat4hX7EPXtLml93Vpa"; //애플리케이션 클라이언트 아이디값"
		String clientSecret = "NJ69nP7K5b"; //애플리케이션 클라이언트 시크릿값"
		...
		try {
			...
			/*String searchNum = req.getParameter("startNum");*/
			text = URLEncoder.encode(searchTxt, "UTF-8");
			/*startnum = URLEncoder.encode(searchNum, "UTF-8");*/
