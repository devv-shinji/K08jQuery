...
<script>
	//JS 함수 내부에서 jQuery코드를 사용하는 것이 가능하다.
	var loadCode = function(){
		//load() 사용시 파라미터가 필요없는 경우 생략이 가능하다. (두번째 인자)
		$('#loadView').load('./common/01LoadSub.jsp');
		alert('문서가 로드되었습니다');
	}
	
	$(function(){
		//외부에 txt파일을 현재 문서로 로드한다.
...
<body>
	<div>
		...
		<label>
			<input type="radio" name="params" value="good"checked />좋은파라미터
		</label>
		<label>
			<input type="radio" name="params" value="bad"/>나쁜파라미터
		</label>
