...
ajaxSetup()
	...
	url, type, data, dataType 등의 속성은 기본적으로 사용되므로 묶어주면 편리하다.
	$ajaxSetup()에서 정의된 속성을 상속받아서 $.ajax()메소드를 실행하는 방식이라 보면된다.
 */
$(function(){
	...
	$('#btn').click(function(){
		$.ajax({
			success : function(responseData) {
				/*
				콜백되는 JSON배열 데이터를 each()로 읽어서 배열의 갯수만큼 반복한다.
				이 때 각 반복시 JSON객체를 파싱하게 된다.
...
/*
	실패시 호출되는 콜백메소드도 콜백데이터를 가지고 있으며 아래와 같이 사용한다.
 */
